...
* [Libra on GitHub](https://github.com/libra/libra) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-08-23 - Official repository
...
* [Libra Wallet](https://github.com/dpikalov/libra-wallet) ⭐ 5 | 🐛 21 | 🌐 CSS | 📅 2023-01-04 - Wallet frontend, don't have backend.
* [LibraTerminal](https://github.com/sns254/LibraTerminal) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2019-07-24 – POC command line wallet.
* [Libra Wallet Poc](https://dev.kulap.io/libra/) - POC Libra wallet.

## Block Explorer

* [librabrowser](https://librabrowser.io/?fbclid=IwAR1LjpGiLWwW3oIFHnM3dm6H47H6D2R0dRAsqjmCcJSNtpW7yCcJu1ud2hE) - Libra Testnet Explorer and its [source code](https://github.com/Disk1n/LibraBrowser) ⭐ 37 | 🐛 12 | 🌐 Python | 📅 2019-08-07.
...
* [LibraBlock](https://librablock.io) - First opensource Libra explorer
  * [librablock-frontend](https://github.com/libra-china-org/librablock-frontend) ⚠️ Archived - Open source frontend
  * [librablock-backend](https://github.com/libra-china-org/librabock-backend) ⚠️ Archived - Open source backend
...
* [libra-core](https://github.com/perfectmak/libra-core) ⭐ 134 | 🐛 31 | 🌐 TypeScript | 📅 2023-01-04 - A javascript client for libra network.
* [libra-web](https://github.com/bandprotocol/libra-web) ⭐ 25 | 🐛 45 | 🌐 JavaScript | 📅 2023-01-04 - Unofficial Javascript Client for Libra Blockchain.
...
* [PyLibra](https://github.com/bandprotocol/pylibra) ⭐ 59 | 🐛 15 | 🌐 Python | 📅 2022-12-08 - Python SDK client for Libra with full client-side functionality.
* [libra-grpc-py](https://github.com/egorsmkv/libra-grpc-py) ⚠️ Archived - gRPC client for Libra in Python.
...
* [libra-utils](https://github.com/Berkays/libra-util) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2019-07-08 - Interface to Libra CLI commands to simplify parsing.
...
* [Awesome Libra](https://github.com/learndapp/awesome-libra) ⭐ 101 | 🐛 0 | 📅 2020-06-22 by LearnDapp
* [Awesome Libra](https://github.com/methuz/Awesome-Libra) ⚠️ Archived by Methuz Kaewsaikao
* [Awesome Libra Blockchain](https://github.com/copperbits/awesome-libra) ⭐ 8 | 🐛 1 | 📅 2019-07-03 by Copperbits
